...
export const intlConfig = {
  ...
  messages: {
    ...
    'tenant.sections.scheduleLiveDesc':
      'Desmarcando essa opção, mesmo que você esteja em horário de funcionamento, seu cardápio não será exibido e você não poderá receber pedidos pelo Click.',
    ...
    'tenant.shipping.takeAwayDesc':
      'O cliente poderá visualizar a morada da sua unidade. Não é adicionada nenhuma taxa no pedido',
    ...
    'tenant.address.success': 'Morada atualizado com sucesso',
    'tenant.address.title': 'Morada da Unidade',
    ...
    'tenant.whatsappPTPlaceholder': 'ex: +351 999 342 545',
    'tenant.whatsappBRPlaceholder': 'ex: +55 11 99143-9987',
    ...
    'tenant.category.lavanderia': 'Lavandeira',
    'tenant.category.lava-rapido': 'Lava-Rapido',
    'tenant.category.florista': 'Florista',
    'tenant.country': 'País',
    'tenant.country.brasil': 'Brasil',
    'tenant.country.portugal': 'Portugal',
    'tenant.countryPlaceholder': 'Selecione o país',
    ...
    'tenant.pendencies.address':
      'Você precisa preencher a morada de seu negócio no painel de Logística',
    ...
    address: 'Morada',
    'address.postalCode': 'Codigo Postal',
    ...
    'address.district': 'Freguesia (opcional)',
    'address.city': 'Concelho',
    ...
    'address.cityRule': 'Preencha seu concelho',
    'address.stateRule': 'Selecione seu estado',
    'address.smartAddress.button': 'Digite sua morada:',
    ...
    'address.searchFor': 'Procure sua Morada',
    'address.confirm': 'Confirme os dados',
    'address.collapseMessage': 'Não encontrou sua morada?',
    'address.noAddress': 'Você não tem nenhuma morada selecionado',
    'address.selectAddress': 'Selecionar Morada',
    'address.selectAddress.back': 'Voltar',
    'address.editAddress': 'Editar Morada',
    'address.form.save': 'Salvar Morada',
    ...
    'order.shipping.addressTake': 'Morada para Retirada',
    ...
    'admin.faturamento': 'Meu faturamento',
    'admin.relatorio': 'Relatórios',
    'admin.breve': ' (Em Breve)',
    ...
    'tenant.sites.info':
      'Estamos configurando o endereço para você usar. Logo estará disponível!',
    ...
    'selectAddress.warningManual':
      'Ao preencher sua morada manualmente você não conseguirá usar a funcionalidade Preço de Entrega Dinâmico',
